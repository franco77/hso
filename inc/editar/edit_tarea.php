...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "edit_tarea")) {
  $updateSQL = sprintf("UPDATE tb_task SET titulo_tarea=%s, asignar_tarea=%s, contenido_tarea=%s, prioridad_tarea=%s, entrega_tarea=%s WHERE id_tarea=%s",
...
<div class="row">
   <div class="col-sm-7">
						...
						<div class="panel-body">
							...
							<form action="<?php echo $editFormAction; ?>" name="edit_tarea" method="POST" role="form">
								...
								<div class="form-group">
									...
									<input name="titulo" type="text" required="required" class="form-control" id="titulo" placeholder="Titulo De La Pagina" value="<?php echo $row_task_edit['titulo_tarea']; ?>">
								</div>
					...
					<textarea name="sample_wysiwyg" required class="form-control wysihtml5" id="sample_wysiwyg" data-stylesheet-url="assets/js/wysihtml5/lib/css/wysiwyg-color.css"><?php echo $row_task_edit['contenido_tarea']; ?></textarea>
				               </div>
						...
						<input name="fecha_entrega" type="text" required="required" class="form-control datepicker" id="fecha_entrega" value="<?php echo $row_task_edit['entrega_tarea']; ?>" data-format="yyyy-mm-dd">

...
<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Mis Tareas Generadas</h3>
  ...
  <a href="edit_me_tareas.php?id_tarea=<?php echo $row_task['id_tarea']; ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
        Editar
        </a>

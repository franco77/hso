...
$query_task = "SELECT * FROM tb_task WHERE asignar_tarea = '$autor'";
...
?>
     ...
     <div class="alert alert-warning">
          ...
          <strong>Nota!</strong> Las Tareas Que Se Listan En Esta Tabla Son Las Tareas Que Otros Usuarios Me Han Asignado.
      </div>
...
<div class="panel panel-default">
				...
				<div class="panel-body">
				    ...
				    <table class="table table-striped" id="example-24">
					    <thead>
					       <tr>
					        <th>#</th>
					        <th>Titulo</th>
...
<?php if ($totalRows_task > 0) {  ?>
  <?php do { ?>
    <tr>
      ...
      <td><a href="edit_me_tareas.php?id_tarea=<?php echo $row_task['id_tarea']; ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
        Editar
        </a>
